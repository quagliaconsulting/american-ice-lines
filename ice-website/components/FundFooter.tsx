...
export default function FundFooter() {
  return (
    <footer className="bg-slate-900 text-gray-400 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/fund/strategy" className="hover:text-white transition-colors">Strategy</Link></li>
              <li><Link href="/fund/portfolio" className="hover:text-white transition-colors">Portfolio</Link></li>
              <li><Link href="/fund/entrepreneurs" className="hover:text-white transition-colors">For Entrepreneurs</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-sm">
          <p>&copy; 2025 American Apex Search Fund. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
